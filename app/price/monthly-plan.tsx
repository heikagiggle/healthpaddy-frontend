...
const MonthlyPlan = () => {
  return (
    <div className="border border-gray-200 shadow-xl bg-white p-6 rounded-lg">
      <div>
      ...
      <button className="mt-28 p-4 text-white w-full bg-[#0E5A61] text-base rounded-[68px] hover:opacity-80 transition-opacity duration-300">
