...
const CustomizedPlan = () => {
  return (
    <div className="border border-gray-200 shadow-lg bg-white p-6 rounded-lg">
      ...
      <button className="mt-16 md:mt-16 lg:mt-[5.6rem] 2xl:mt-[7rem] p-4 text-white w-full bg-[#0E5A61] text-base rounded-[68px] hover:opacity-80 transition-opacity duration-300">
